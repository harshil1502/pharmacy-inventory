...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-50 h-full w-64 transform bg-white border-r border-gray-200 transition-transform duration-200 lg:translate-x-0 lg:static lg:z-auto',
        ...
        <div className="border-t border-gray-200 px-3 py-3">
          <div className="flex items-center justify-between p-3 rounded-md bg-gray-50">
            <div className="flex items-center space-x-2.5">
              ...
              <span className="text-sm text-gray-700 capitalize font-medium">{user?.full_name || user?.role || 'User'}</span>
            </div>
            <span className={cn(
